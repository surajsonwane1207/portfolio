...
(function () {
    function c() {
        ...
        if (b) {
            ...
            d.innerHTML = "window.__CF$cv$params={r:'9f359ae8168b3f03',t:'MTc3NzM3NDQ2NS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);"; b.getElementsByTagName('head')[0].appendChild(d)
        }
    }
    if (document.body) {
